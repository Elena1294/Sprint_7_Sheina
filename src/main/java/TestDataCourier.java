public class TestDataCourier {
    ...
    public static final String FIRST_NAME = "NewName"+ (10000 + (int)(Math.random() *99999));

    public static final String CREATED_LOGIN = "Helen14";
    public static final String CREATED_PASSWORD = "new123";
    public static final String CREATED_FIRST_NAME = "Elena";
}
